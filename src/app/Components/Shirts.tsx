...
const product:Iproducts[] = [
    {
     ...
     id:1,
     price:"$120",
     img_url:"/arrivalsImages/1.png"
    },
    {
     title:"SKINNY FIT JEANS",
     id:2,
     price:"$120",
     img_url:"/arrivalsImages/2.png",
     old_price:"$200"
    },
    {
     ...
     id:3,
     price:"$120",
     img_url:"/arrivalsImages/3.png"
    },
    {
     title:"T-SHIRT WITH TAPE DETAILS",
     id:13,
     price:"$120",
     img_url:"/arrivalsImages/4.png"
    },
    {
     title:"SKINNY FIT JEANS",
     id:14,
     price:"$120",
     img_url:"/topSellingImages/5.png",
     old_price:"$200"
    },
    {
     title:"CHECKERED SHIRT",
     id:15,
     price:"$120",
     img_url:"/topSellingImages/6.png",
    },
    {
     title:"T-SHIRT WITH TAPE DETAILS",
     id:16,
     price:"$120",
     img_url:"/topSellingImages/7.png"
    },
    {
     title:"SKINNY FIT JEANS",
     id:17,
     price:"$120",
     img_url:"/topSellingImages/8.png",
     old_price:"$200"
    },
    {
     title:"CHECKERED SHIRT",
     id:18,
     price:"$120",
     img_url:"/topSellingImages/9.png"
    },
